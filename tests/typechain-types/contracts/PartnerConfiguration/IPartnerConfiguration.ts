...
export interface IPartnerConfigurationInterface extends utils.Interface {
  functions: {
...
export interface IPartnerConfiguration extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPartnerConfigurationInterface;
