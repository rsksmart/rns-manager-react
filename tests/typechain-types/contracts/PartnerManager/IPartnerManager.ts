...
export interface IPartnerManagerInterface extends utils.Interface {
  functions: {
...
export interface IPartnerManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPartnerManagerInterface;
  ...
  functions: {
    ...
    setPartnerConfiguration(
      partner: PromiseOrValue<string>,
      configuration: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  };
