 ...
 */
export const resolveDomain = (domain, errorFunction = null, value = null) => async (dispatch) => {
  const rnsSdk = rns();
...
export const getAddress = (resolverAddress, supportedInterfaces, domain, chainId) => (dispatch) => {
